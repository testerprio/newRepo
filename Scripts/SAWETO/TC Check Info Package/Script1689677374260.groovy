...
WebUI.click(findTestObject('SAWETO/Sidebar Menu/i2. infoPackage'))
...
actualInfoPackage = CustomKeywords.'com.saweto.additionalKeyword.getTextFromTable'(findTestObject('SAWETO/tblListData'), 
    3)

WebUI.takeElementScreenshot(findTestObject('SAWETO/tblListData'))

intValidity = (Integer.parseInt(GlobalVariable.expectedValidity) - 1)

expectedInfoPackage = CustomKeywords.'com.saweto.additionalKeyword.replaceDateInStatement'(GlobalVariable.expectedInfoPackage, 
    dateInProcon, intValidity, expectedFormatDate)

WebUI.verifyEqual(actualInfoPackage, expectedInfoPackage)
